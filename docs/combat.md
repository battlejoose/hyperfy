...
| Key F / mobile KICK button (left of combat sticks) | Kick — breaks an opponent’s block |
...
| Mobile block joystick (bottom-right, under attack stick) | Same drag logic as right mouse — touch down begins drag, deflect adds drag delta, release lowers block |
